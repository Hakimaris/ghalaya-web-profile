  ...
  return (
    <section className="bg-neutral">
      <div className="container flex flex-col items-center p-2 mx-auto space-y-6 md:p-6">
        ...
        <p className="px-6 py-1 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-info">
          Kami melayani pengangkutan barang via jalur pelayaran di Indonesia
        </p>
      </div>
    </section>
  );
