    ...
    <footer className="bg-info text-white py-4 text-center">
      <ul className="flex justify-center items-center">
        <li className="pb-4 space-x-5">
          <a href="#" className="font-semibold">{t("navbar.tentangKami")}</a>
          <a href="#" className="font-semibold">{t("navbar.klien")}</a>
          <a href="#" className="font-semibold">{t("navbar.sertifikasi")}</a>
          <a href="#" className="font-semibold">{t("navbar.kontak")}</a>
        </li>
      </ul>
      <ul className="flex justify-center items-center">
