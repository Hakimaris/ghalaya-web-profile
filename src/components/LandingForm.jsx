...
export default function LandingForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoUrl = `mailto:info@ghalaya.com?subject=Contact Form Submission&body=Name: ${name}%0D%0AEmail: ${email}%0D%0AMessage: ${message}`;
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-info rounded-lg shadow-2xl dark:bg-info lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
              ...
              <form className="mt-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="overflow-y-auto w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-info capitalize transition-colors duration-300 transform bg-neutral rounded-md hover:bg-secondary focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                >
